...
componentDidMount(){
    //code to load the api, in the file, I had written data directly to the state
}

    editStudent = (index, name) => {
        let tempObject = [...this.state.students];
        // let tempObject = this.state.students;
        // let tempStudentObj = {...tempObject[index]};
        let tempStudentObj = tempObject[index];

        tempStudentObj['Name'] = name;
        tempObject[index] = tempStudentObj;

        this.setState({students: tempObject});
    }
    ...
    render() {
        // console.log("student's Render compnoent');
        return (<div className="students-container">
                ...
                {this.state.students.map((content, index) => {
                    return <Student
                        ...
                        editStudent={this.editStudent}></Student>
                })}
